...
public class NewsActivity extends AppCompatActivity
    ...
    //Break down URL into URI pieces
    @Override
...
//        uriBuilder.appendQueryParameter("order-by", "oldest");
    ...
    //Preference settings: inflate options menu - the settings for preferences
    @Override
    ...
    //Preference settings: set up action which occurs when option menus selected clicked
    //a. passes menu item selected
    //b. options menu may have more than one items
    @Override
